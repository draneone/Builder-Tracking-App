...
import '../task_create/task_create_widget.dart';
...
class _DocsWidgetState extends State<DocsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<DocRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DocRecord> docsDocRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final doclist = docsDocRecordList?.toList() ?? [];
